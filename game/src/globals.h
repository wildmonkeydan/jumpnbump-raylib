...
#define KEY_PL1_LEFT KEY_A
#define KEY_PL1_RIGHT KEY_D
#define KEY_PL1_JUMP KEY_W
#define KEY_PL2_LEFT KEY_LEFT
#define KEY_PL2_RIGHT KEY_RIGHT
#define KEY_PL2_JUMP KEY_UP
#define KEY_PL3_LEFT KEY_J
#define KEY_PL3_RIGHT KEY_L
#define KEY_PL3_JUMP KEY_I
#define KEY_PL4_LEFT KEY_KP_4
#define KEY_PL4_RIGHT KEY_KP_6
#define KEY_PL4_JUMP KEY_KP_8
